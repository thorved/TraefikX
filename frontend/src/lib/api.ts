...
export const authApi = {
  ...
  // OIDC
  getOIDCStatus: () => api.get<{ enabled: boolean; provider_name?: string }>('/api/auth/oidc/status'),

  initiateOIDC: () => api.get<{ auth_url: string; state: string }>('/api/auth/oidc'),

  initiateOIDCLink: () => api.post<{ auth_url: string; state: string }>('/api/auth/oidc/link'),
